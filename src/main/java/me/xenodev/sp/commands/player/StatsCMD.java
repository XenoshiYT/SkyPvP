...
public class StatsCMD implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        // /stats name set/add/remove kills/tode/streak anzahl
        // /stats name reset
        // /stats name/reset
        // /stats
        if(cmd.getName().equalsIgnoreCase("stats")){
            if(args.length == 5){
                if(!p.hasPermission("skypvp.stats.edit")){
                    p.sendMessage(Main.getInstance().error + " §cDu hast dazu keine Rechte. Du benötigst: §6" + "skypvp.stats.edit");
                    return true;
                }
                ...
                if(args[1].equalsIgnoreCase("set")){
                    if(args[2].equalsIgnoreCase("kills")){
                        if(Main.getInstance().datasave.equalsIgnoreCase("File")){
                            ...
                            p.sendMessage(Main.getInstance().prefix + " §7Du hast dem Spieler §a" + t.getName() + " §7die Kills auf §e" + amount + " §7gesetzt");
                        ...
                        if(Main.getInstance().datasave.equalsIgnoreCase("File")){
                            ...
                            p.sendMessage(Main.getInstance().prefix + " §7Du hast dem Spieler §a" + t.getName() + " §7die Tode auf §e" + amount + " §7gesetzt");
                        }else if(Main.getInstance().datasave.equalsIgnoreCase("MySQL")){
                        ...
                        if(Main.getInstance().datasave.equalsIgnoreCase("File")){
                            ...
                            p.sendMessage(Main.getInstance().prefix + " §7Du hast dem Spieler §a" + t.getName() + " §7die Streak auf §e" + amount + " §7gesetzt");
                        }else if(Main.getInstance().datasave.equalsIgnoreCase("MySQL")){
                            StatsSQL.setStreak(t.getUniqueId(), amount);
                            p.sendMessage(Main.getInstance().prefix + " §7Du hast dem Spieler §a" + t.getName() + " §7die Streak auf §e" + amount + " §7gesetzt");
                        }
                    }else{
                        p.sendMessage(Main.getInstance().error + " §cDie Aussage §6" + args[2] + " §cwurde nicht gefunden");
                        p.sendMessage(Main.getInstance().error + " §7Benutze doch bitte <kills, tode, streak>");
                    }
                }else if(args[1].equalsIgnoreCase("add")){
                    if(args[2].equalsIgnoreCase("kills")){
                        if(Main.getInstance().datasave.equalsIgnoreCase("File")){
                            StatsFilebuilder.addKills(t, amount);
                            p.sendMessage(Main.getInstance().prefix + " §7Du hast dem Spieler §a" + t.getName() + " §e" + amount + " §7Kills hinzugefügt");
                        }else if(Main.getInstance().datasave.equalsIgnoreCase("MySQL")){
                        ...
                        if(Main.getInstance().datasave.equalsIgnoreCase("File")){
                            ...
                            p.sendMessage(Main.getInstance().prefix + " §7Du hast dem Spieler §a" + t.getName() + " §e" + amount + " §7Tode hinzugefügt");
                        }else if(Main.getInstance().datasave.equalsIgnoreCase("MySQL")){
                        ...
                        if(Main.getInstance().datasave.equalsIgnoreCase("File")){
                            ...
                            p.sendMessage(Main.getInstance().prefix + " §7Du hast dem Spieler §a" + t.getName() + " §e" + amount + " §7Streak-Punkte hinzugefügt");
                        }else if(Main.getInstance().datasave.equalsIgnoreCase("MySQL")){
                    ...
                    if(args[2].equalsIgnoreCase("kills")){
                        if(Main.getInstance().datasave.equalsIgnoreCase("File")){
                            ...
                            p.sendMessage(Main.getInstance().prefix + " §7Du hast dem Spieler §a" + t.getName() + " §e" + amount + " §7Kills abgezogen");
                        }else if(Main.getInstance().datasave.equalsIgnoreCase("MySQL")){
                        ...
                        if(Main.getInstance().datasave.equalsIgnoreCase("File")){
                            ...
                            p.sendMessage(Main.getInstance().prefix + " §7Du hast dem Spieler §a" + t.getName() + " §e" + amount + " §7Tode abgezogen");
                        }else if(Main.getInstance().datasave.equalsIgnoreCase("MySQL")){
                        ...
                        if(Main.getInstance().datasave.equalsIgnoreCase("File")){
                            ...
                            p.sendMessage(Main.getInstance().prefix + " §7Du hast dem Spieler §a" + t.getName() + " §e" + amount + " §7Streak-Punkte abgezogen");
                        }else if(Main.getInstance().datasave.equalsIgnoreCase("MySQL")){
                    ...
                    p.sendMessage(Main.getInstance().error + " §cDie Aussage §6" + args[1] + " §cwurde nicht gefunden");
                    p.sendMessage(Main.getInstance().error + " §7Benutze doch bitte <set, add, remove>");
                }
            }else if(args.length == 3){
                if(!p.hasPermission("skypvp.stats.reset")){
                    p.sendMessage(Main.getInstance().error + " §cDu hast dazu keine Rechte. Du benötigst: §6" + "skypvp.stats.reset");
                    return true;
                }
                OfflinePlayer t = Bukkit.getOfflinePlayer(args[0]);
                if(args[1].equalsIgnoreCase("reset")){
                    if(Main.getInstance().datasave.equalsIgnoreCase("File")){
                        ...
                        p.sendMessage(Main.getInstance().prefix + " §7Du hast die Stats von §e" + t.getName() + " §7zurückgesetzt");
                    }else if(Main.getInstance().datasave.equalsIgnoreCase("MySQL")){
                    ...
                    p.sendMessage(Main.getInstance().error + " §cDie Aussage §6" + args[1] + " §cwurde nicht gefunden");
                    p.sendMessage(Main.getInstance().error + " §7Benutze doch bitte <reset>");
                }
                ...
                if(args[0].equalsIgnoreCase("reset")){
                    if(Main.getInstance().datasave.equalsIgnoreCase("File")){
                        ...
                        p.sendMessage(Main.getInstance().prefix + " §7Du hast deine Stats zurückgesetzt");
                    }else if(Main.getInstance().datasave.equalsIgnoreCase("MySQL")){
                    ...
                    if(Main.getInstance().datasave.equalsIgnoreCase("File")){
                        p.sendMessage(Main.getInstance().prefix + " §7Die Stats von §e§l" + t.getName() + "§7:");
                ...
                if(Main.getInstance().datasave.equalsIgnoreCase("File")){
                    p.sendMessage(Main.getInstance().prefix + " §7Die Stats von §a§lDir" + "§7:");
                ...
                p.sendMessage(Main.getInstance().error + " §7cDer Befehl konnte so nicht aufgefasst werden, Benutze lieber:");
                p.sendMessage(Main.getInstance().error + " §7/stats <name> <set, add, remove> <kills, tod, streak> <anzahl>");
                p.sendMessage(Main.getInstance().error + " §7/stats <name> <reset>");
                p.sendMessage(Main.getInstance().error + " §7/stats <name, reset>");
                p.sendMessage(Main.getInstance().error + " §7/stats");
            }
        }
        return false;
    }
