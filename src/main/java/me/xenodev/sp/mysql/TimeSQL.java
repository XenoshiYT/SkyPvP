...
public class TimeSQL {
    ...
    public static void setHours(UUID uuid, Integer hours){
        if(playerExists(uuid)){
            Main.getInstance().mysql.update("UPDATE Time SET HOURS= '" + hours + "' WHERE UUID= '" + uuid + "';");
        }else{
            createPlayer(uuid);
            setHours(uuid, hours);
        }
    ...
    public static void setMinutes(UUID uuid, Integer minutes){
        if(playerExists(uuid)){
            Main.getInstance().mysql.update("UPDATE Time SET MINUTES= '" + minutes + "' WHERE UUID= '" + uuid + "';");
        }else{
            createPlayer(uuid);
    ...
    public static void setSeconds(UUID uuid, Integer seconds){
        if(playerExists(uuid)){
            Main.getInstance().mysql.update("UPDATE Time SET SECONDS= '" + seconds + "' WHERE UUID= '" + uuid + "';");
        }else{
            createPlayer(uuid);
